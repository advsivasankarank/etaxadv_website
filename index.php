...
<main id="main-content">
  ...
  <section class="cta-band">
    <div class="container">
      ...
      <p>Whether you need GST &amp; Income Tax filing support, Compliance Management, or face a regulatory challenge — our team is ready to assist.</p>
  ...
  <section class="section section-alt" id="core-services">
    <div class="container">
      <div class="section-header">
        ...
        <h2 class="section-title">Focused expertise across four key pillars</h2>
      </div>
      <div class="core-services-grid">
        <div class="core-service-card">
          <h3>Tax Advisory</h3>
          <p>GST, Income Tax, TDS, Assessments and Appeals.</p>
        </div>
        <div class="core-service-card">
          <h3>Legal &amp; Representation</h3>
          <p>Replies, Appeals, Litigation Support and Statutory Representation.</p>
        </div>
        <div class="core-service-card">
          <h3>Compliance Management</h3>
          <p>Labour Law, Corporate Compliance and Regulatory Reporting.</p>
        </div>
        <div class="core-service-card">
