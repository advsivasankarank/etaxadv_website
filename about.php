<?php
$page_title = "About the Company | E Tax Advisors Private Limited";
$page_description = "Learn about E Tax Advisors Private Limited — a multidisciplinary tax, legal, compliance and business advisory firm founded by K. Sivasankaran.";
$page_path = '/about.php';
  ...
  <section class="trust-bar">
    <div class="container">
      <div class="trust-bar-grid">
        ...
        <div class="trust-bar-item"><strong>11 Years</strong><span>of Trusted Service</span></div>
